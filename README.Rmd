...
- [RestRserve](https://restrserve.org/): the 2nd most populat framework accounting for 2% of the total downloads. See the [`RestRserve.R`](inst/examples/RestrServe.R) example.
